...
public class PetInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pet pet = new Gson().fromJson(getIntent().getStringExtra(PetsActivity.PET_KEY), Pet.class);
    ...
    private class ArticleAdapter extends ArrayAdapter<Pet.Article> {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            GradientDrawable circle = (GradientDrawable) convertView.findViewById(R.id.article_circle_IV).getBackground();
            circle.setColor(Color.rgb(article.RGB_themeColor[0], article.RGB_themeColor[1], article.RGB_themeColor[2]));
            ((ImageView) convertView.findViewById(R.id.article_circle_IV)).setBackground(circle);
            ...
            ((ImageButton) convertView.findViewById(R.id.article_button_IB)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    articleActivity.putExtra(ARTICLE_KEY, new Gson().toJson(article));
